...
describe('UsuariosModule (e2e)', () => {
  ...
  it('PATCH /usuarios/:id deve retornar 200 e modificar o próprio usuário', async () => {
    ...
    expect(res.body.cpf_cnpj).toBe('90909090909');
